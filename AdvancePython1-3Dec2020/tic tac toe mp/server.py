...
"font: 20pt \"MS Shell Dlg 2\";")
    ...
    def user_move(self):
        btn = self.sender()
        self.user_pos=int(btn.text())
        btn.setDisabled(True)
        btn.setText(self.user_ch)
        self.winner(self.user_pos,self.user_ch)
        self.sendPosition(self.user_pos)
    ...
    def setClientPos(self,pos):
        ...
        self.winner(pos,self.client_ch)
    ...
    def winner(self,pos,ch):
        ...
        for i in range(len(self.combinations)):
            if self.combinations[i][0]==ch and self.combinations[i][1]==ch and self.combinations[i][2]==ch:
                    QMessageBox.about(self,"Game Over","Server win")

    def sendPosition(self,pos):
            msg = {"pos":pos,"Server_ch":self.user_ch,"client_ch":self.client_ch}
            msg = json.dumps(msg)
    ...
    def startServer(self):
        ...
        while True:
           ...
           self.setClientPos(self.clientPos)
        self.conn.close()
